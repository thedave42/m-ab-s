...
if %noMintty%==y (
    ...
    start "compile" /I /B /LOW %CD%\msys64\usr\bin\mintty.exe -i /msys2.ico -t "media-autobuild_suite" ^
...
if %noMintty%==y (
    ...
    start /I /B /LOW /WAIT %instdir%\msys64\usr\bin\mintty.exe -d -i /msys2.ico ^
