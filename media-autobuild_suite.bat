...
if %noMintty%==y (
    ...
    start "compile" /I /B /LOW %CD%\msys64\usr\bin\mintty.exe -i -no-start /msys2.ico -t "media-autobuild_suite" ^
...
if %noMintty%==y (
    ...
    start /I /B /LOW /WAIT %instdir%\msys64\usr\bin\mintty.exe -no-start -d -i /msys2.ico ^
